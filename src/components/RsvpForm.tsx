...
export default function RsvpForm({ birthdayGirl, adminPin }: RsvpFormProps) {
    ...
    <div className="w-full max-w-4xl px-4 flex flex-col items-center gap-8 mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
        ...
        <div className="lg:col-span-12 xl:col-span-12 flex flex-col items-center">
          <div className="w-full max-w-2xl p-6 sm:p-8 rounded-2xl bg-[#0a170a]/90 border border-[#c5a059]/30 hover:border-[#c5a059]/50 shadow-2xl backdrop-blur-md relative transition-all">
            <div className="absolute top-0 right-1/2 translate-x-1/2 -translate-y-1/2 bg-[#0a170a] text-[#c5a059] border border-[#c5a059] font-semibold text-[10px] sm:text-xs uppercase px-5 py-1.5 rounded-full tracking-widest shadow-md">
          ...
          <AnimatePresence>
            {showAdmin && (
              <motion.div
                ...
                animate={{ opacity: 1, height: 'auto' }}
                exit={{ opacity: 0, height: 0 }}
                className="w-full max-w-2xl mt-4 bg-[#0a170a]/95 border border-[#c5a059]/30 rounded-2xl p-5 overflow-hidden shadow-2xl backdrop-blur-md font-sans"
              >
                {!isUnlocked ? (
                  <motion.form
                    initial={{ opacity: 0 }}
