...
export default function EventDetails({ config }: EventDetailsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl px-4 font-sans select-none">
      ...
      {/* Location card */}
      <motion.div
        className="relative p-6 sm:p-8 rounded-2xl bg-[#0a170a]/90 border border-[#c5a059]/30 hover:border-[#c5a059]/55 shadow-2xl backdrop-blur-md transition-all"
        whileHover={{ y: -4 }}
      ...
      >
        ...
        <div className="mt-6 rounded-xl overflow-hidden border border-[#c5a059]/30 relative h-36 bg-[#030a03]">
          <div className="absolute inset-0 bg-gradient-to-b from-[#0a170a] to-[#030a03] flex flex-col justify-center items-center">
            {/* Elegant dark grid */}
      ...
      <div className="flex flex-col gap-6">
        ...
        {/* Dress Code */}
        <motion.div
          className="p-6 sm:p-8 rounded-2xl bg-[#0a170a]/90 border border-[#c5a059]/30 hover:border-[#c5a059]/55 shadow-2xl backdrop-blur-md transition-all"
          whileHover={{ y: -4 }}
          transition={{ duration: 0.3 }}
        >
          ...
          <div className="p-4 rounded-xl bg-white/5 border border-[#c5a059]/30 flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-white/95 font-medium font-serif italic text-sm">Gala y Elegancia</span>
              <span className="text-[10px] uppercase tracking-wider text-[#c5a059] mt-0.5 font-sans font-semibold">Detalle en Verde o Dorado</span>
            </div>
        ...
        {/* Gifts info */}
        <motion.div
          className="p-6 sm:p-8 rounded-2xl bg-[#0a170a]/90 border border-[#c5a059]/30 hover:border-[#c5a059]/55 shadow-2xl backdrop-blur-md relative overflow-hidden flex flex-col justify-between flex-1 transition-all"
          whileHover={{ y: -4 }}
          transition={{ duration: 0.3 }}
        >
